...
urlpatterns = [
    ...
    path('adminProductEdit/<int:id>/', views.editProduct_form_submission, name='editAProduct'),
    path('update_item/', views.updateItem, name="update_item"),
    path('adminViewProduct/<int:id>/', views.deleteProduct_form_submission, name='deleteProduct')
]
